...
if __name__== "__main__":
    ...
    save_dir = 'E:\Agile_intern\handeye_calibration\eye2hand_cam1'

    # calibrate camera
    cam_calib = IntrinsicCalibration(save_dir=save_dir, img_dir='E:\Agile_intern\handeye_calibration\eye2hand_cam1\img_2')
    cam_calib.calibrate()
    # calib.draw_pose()

    # calibrate handeye
    handeye_calib = HandEyeCalibration(save_dir=save_dir, img_dir='E:\Agile_intern\handeye_calibration/eye2hand_cam1/img_4', 
                                       posefile='E:\Agile_intern\handeye_calibration/eye2hand_cam1/img_4/pose.npy', 
                                       eye_to_hand=True)
    handeye_calib.calibrate()
    handeye_calib.save(method=cv.CALIB_HAND_EYE_TSAI)
